...
async function main() {
  ...
  const token1 = await TToken.attach(
  ...
  const bfactory = await BFactory.attach(
    "0xB8D12Ce829Cb0482f730D3C0FD6A203E029056EE"
  );
  ...
  const txApprove2 = await token1.approve(
    pool_address,
  ...
  let tokensBalances = ["60000", "50000"];
