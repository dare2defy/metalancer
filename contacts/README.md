...
The _🍂Bronze Release🍂_ is the first of 3 planned releases of the Balancer Protocol. Bronze emphasizes code clarity for audit and verification, and does not go to great lengths to optimize for gas.

The _❄️Silver Release❄️_ will bring many gas optimizations and architecture changes that will reduce transaction overhead and enable more flexibility for managed pools.

The _☀️Golden Release☀️_ will introduce a curious new liquidity mechanism to the market.
